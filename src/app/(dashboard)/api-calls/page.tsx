...
const API_DOCS: ApiDoc[] = [

  {
    ...
    name: 'Email • Find',
    method: 'POST',
    url: 'http://server.mailsfinder.com/api/access-key/email/findEmail',
    displayUrl: 'http://server.mailsfinder.com/api/access-key/email/findEmail',
  ...
  },
  {
    ...
    name: 'Email • Find Bulk',
    method: 'POST',
    url: 'http://server.mailsfinder.com/api/access-key/email/findBulkEmail',
    displayUrl: 'http://server.mailsfinder.com/api/access-key/email/findBulkEmail',
  ...
  },
  {
    ...
    name: 'Email • Verify Bulk',
    method: 'POST',
    url: 'http://server.mailsfinder.com/api/access-key/email/verifyBulkEmail',
    displayUrl: 'http://server.mailsfinder.com/api/access-key/email/verifyBulkEmail',
    description: 'Verify a list of emails',
    headers: { 'Authorization': 'Bearer API_••••••••398e', 'Content-Type': 'application/json' },
  ...
  },
  {
    ...
    name: 'Email • Verify',
    method: 'POST',
    url: 'http://server.mailsfinder.com/api/access-key/email/verifyEmail',
    displayUrl: 'http://server.mailsfinder.com/api/access-key/email/verifyEmail',
