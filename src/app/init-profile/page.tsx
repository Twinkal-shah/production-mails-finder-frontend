      ...
      <div className="max-w-md w-full space-y-8 p-8 bg-white rounded-lg shadow-md">
        <div className="text-center">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex justify-center py-3 px-4 rounded-[12px] shadow-sm text-sm font-bold text-white bg-brand-gradient focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
